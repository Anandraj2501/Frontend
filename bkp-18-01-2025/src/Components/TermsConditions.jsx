...
<p className='text-[1rem] pb-2'>TripCafe makes no promises regarding the effectiveness or acceptance of the Dummy Ticket makes no promises regarding the effectiveness or acceptance of the Dummy Ticket.</p>
<p className='text-[1rem] pb-2'>TripCafe is Not Responsibility for Visa Rejection: The business explicitly states that it is not responsible if your visa is rejected for any reason, whether related to the Dummy Ticket or not.</p>
<p className='text-[1rem] pb-2'>Purchase at Your Own Risk: By purchasing the Dummy Ticket, you acknowledge that you are doing so at your own risk, and the business does not assure or guarantee that the Dummy Ticket will help in securing your visa or fulfill your intended purpose.</p>
