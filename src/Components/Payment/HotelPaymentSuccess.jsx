                ...
                <div className="container mx-auto sm:w-[60%] md:w-[60%] lg:w-[60%] xl:w-[60%] 2xl:w-[60%] px-[2%] sm:px-[5.5%] md:px-[5.5%] lg:px-[5.5%] xl:px-[5.5%] py-10">
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <div className="w-full">
                            ...
                            <p>Your Dummy Hotel Ticket Booking Payment is <span className=" text-green-500 font-bold">Confirmed</span> with referenceId: <span className=" text-green-500 font-bold">{bookingdata?.referenceId}</span>. You will recieve your Dummy Hotel Ticket on your email soon.</p>
                        </div>
