...
const HotelBookingDetails = () => {
    ...
    const handlePaymentClick = () => {
        console.log(hotelTravellersDetails, hotelData);
                            ...
                            <div className="left-detail mt-10">
                                ...
                                <div className="pt-6 px-2">
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <input type="text" placeholder="Name" className="border rounded-md p-3" name="name" value={hotelTravellersDetails.contactDetails.name}
                                            onChange={handleInputsChange} />
                                        <input type="text" placeholder="Email" className="border rounded-md p-3" name="email" value={hotelTravellersDetails.contactDetails.email}
                                            onChange={handleInputsChange} />
                                    </div>
                                                ...
                                                <div className="left w-[50%] flex flex-col gap-6">
                                                    <div className="flex">
                                                        <select className="dropdown border rounded-md p-3 rounded-r-none" value={passenger.title}
                                                            onChange={(e) => handlePassengerChange(index, e)} name="title">
                                                            <option value="Mr">Mr</option>
                                                            <option value="Ms">Ms</option>
                                                            <option value="Mrs">Mrs</option>
                                                        </select>
                                                        <input type="text" name="firstName" placeholder="First Name" className="w-full border rounded-md rounded-l-none p-3" value={passenger.firstName} onChange={(e) => handlePassengerChange(index, e)} />
                                                    </div>
                                                    {/* <input type="date" name="dob" placeholder="DOB" className="w-full border rounded-md p-3" value={passenger.dob} onChange={(e) => handlePassengerChange(index, e)} /> */}
                                                </div>
                        ...
                        <div className="right-detail mt-10 w-[100%] sm:w-[37%] md:w-[30%] lg:w-[30%] xl:w-[30%] 2xl:w-[30%]   flex flex-col">
                            ...
                            <div className="detai pt-6">
                                <div className="flex flex-col gap-2 mt-2">
                                    <hr className="border-b border-dashed border-gray-400" />
                                    <div className="flex justify-between ">
                                        <span>Amount * {hotelTravellersDetails.passengers.length}</span>
                                        <span>{400 * hotelTravellersDetails.passengers.length}</span>
                                    </div>
                                    <hr className="border-b border-dashed border-gray-400" />
                                    <div className="flex justify-between">
                                        <span>Total</span>
